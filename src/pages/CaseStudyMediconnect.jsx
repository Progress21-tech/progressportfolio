...
export default function CaseStudyMediconnect() {
  return (
    <div className="cs">
      ...
      <div className="cs-body">
        <section className="cs-section">
          ...
          <p>
            Mediconnect is an <strong>event-marketing startup</strong> — a young company
        ...
        <section className="cs-section">
          ...
          <p>
            The site is only half the story. I built Mediconnect a <strong>custom content
        ...
        <section className="cs-section">
          ...
          <p>
            Mediconnect went from <strong>no real web presence</strong> to a polished,
      ...
      <footer>
        <div className="wrap foot-in">
          ...
          <span>Mediconnect case study</span>
        </div>
      </footer>
    </div>
  );
